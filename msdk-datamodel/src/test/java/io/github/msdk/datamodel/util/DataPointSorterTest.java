...
public class DataPointSorterTest {
    ...
    public void testMzSortAsc() {
        double mzBuffer[] = { 200.0, 200.0001, 200.0002, 300.0, 333.0, 32.0,
                35.0, 0.0, 0.0 };
        float intensityBuffer[] = { 320f, 35f, 20f, 200.0001f, 200.0002f, 3f,
                30f, 0f, 20f };
        int size = 7;
        DataPointSorter.sortDataPoints(mzBuffer, intensityBuffer, size,
    ...
    public void testMzSortDesc() {
        double mzBuffer[] = { 32.0, 35.0, 200.0, 200.0001, 200.0002, 333.0,
                300.0, 0.0, 0.0 };
        float intensityBuffer[] = { 320f, 35f, 20f, 200.0001f, 200.0002f, 3f,
                30f, 0f, 20f };
        int size = 7;
    ...
    public void testIntensitySortAsc() {
        ...
        int size = 7;
        DataPointSorter.sortDataPoints(mzBuffer, intensityBuffer, size,
                SortingProperty.INTENSITY, SortingDirection.ASCENDING);
        for (int i = 1; i < size; i++) {
