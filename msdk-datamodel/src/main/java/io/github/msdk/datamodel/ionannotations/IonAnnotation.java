...
public interface IonAnnotation extends Comparable<IonAnnotation> {
  ...
  /**
   * Sets a new chemical structure annotation to this annotation. Chemical formula annotation should
   * include charge, e.g. C6H13O6+ or [C34H58N5O35P3]2-.
   *
  ...
  /**
   * Sets the expected m/z value to this annotation. The expected m/z value can be the calculated
   * value based on the chemical formula or a value from a database.
   *
  ...
  /**
   * Sets a new taxonomy id from the NEWT taxonomy for the species associated to this annotation.
   *
  ...
  /**
   * Sets a new database description to this annotation. Generally references the used
   * identification or spectral library.
   *
  ...
  /**
   * Sets a new database version description to this annotation. Either the version of the used
  ...
  /**
   * Sets a new textual reference to a spectrum in a spectrum file for this annotation. The
   * reference must be in the format ms_run[1-n]:{SPECTRA_REF}. Multiple spectra can be referenced
  ...
  /**
   * Sets a "|" delimited list of search engine(s) that identified this annotation.
   *
  ...
  /**
   * Sets the reliability of the identification. This must be reported as an integer between 1-4: 1:
   * Identified metabolites 2: Putatively annotated compounds 3: Putatively characterized compound
   * classes 4: Unknown compounds
   *
