...
class SimpleChromatographyInfo implements ChromatographyInfo {
  ...
  SimpleChromatographyInfo(@Nonnull Float retentionTime, @Nullable Float secondaryRetentionTime,
      @Nullable Float ionDriftTime, @Nullable SeparationType separationType) {
  ...
  public int compareTo(ChromatographyInfo o) {
    ...
    if (returnValue == 0) {
      ...
      if (secondaryRetentionTime != null && o.getSecondaryRetentionTime() != null) {
        returnValue = secondaryRetentionTime.compareTo(o.getSecondaryRetentionTime());
      } else if (secondaryRetentionTime == null && o.getSecondaryRetentionTime() == null) {
        returnValue = 0;
  ...
  public String toString() {
    if (separationType.getFeatureDimensions() == 1) {
      ...
      return String.format("%sx%s (%s)", retentionTime, ionDriftTime, separationType);
    } else {
      return String.format("%sx%s (%s)", retentionTime, secondaryRetentionTime, separationType);
    }
  }
}
