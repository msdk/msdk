...
/**
 * Represents the ion isolation information. Each isolation can be accompanied
 * by MS/MS fragmentation, represented by FragmentationInfo. If no fragmentation
 * occurred or if fragmentation details are unknown, getFragmentationInfo() will
 * return null. For convenience, this interface is immutable, so it can be
 * passed by reference and safely used by multiple threads.
 */
@Immutable
public interface IsolationInfo {
    ...
    /**
     * Returns the precursor charge. Null is returned if the charge is unknown
