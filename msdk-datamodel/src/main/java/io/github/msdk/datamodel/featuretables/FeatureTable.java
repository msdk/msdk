...
public interface FeatureTable {
  ...
  /**
   * Returns a specific column for the given {@code columnName}. May return {@code null} if no
   * column for the given name is known.
   *
   ...
   */
  @Nullable
  <DATATYPE> FeatureTableColumn<DATATYPE> getColumn(@Nonnull String columnName, Sample sample,
