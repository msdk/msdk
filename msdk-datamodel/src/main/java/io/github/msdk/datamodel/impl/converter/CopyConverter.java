...
public class CopyConverter implements FeatureTableDataConverter<Object> {
  ...
  /** {@inheritDoc} */
  @Override
  public void apply(FeatureTableRow sourceRow, FeatureTableColumn<? extends Object> sourceColumn,
      FeatureTableRow targetRow, FeatureTableColumn<? extends Object> targetColumn) {
    ...
    if (targetColumn.getDataTypeClass().isAssignableFrom(sourceColumn.getDataTypeClass())) {
      ...
      throw new MSDKConstraintViolationException(
          "Target column data type '" + targetColumn.getDataTypeClass().getName()
