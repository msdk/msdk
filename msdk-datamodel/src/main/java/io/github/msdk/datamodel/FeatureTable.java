...
public interface FeatureTable {
   ...
   *
   * @return a list of {@link io.github.msdk.datamodel.FeatureTableRow}s.
   */
  @Nonnull
  List<FeatureTableRow> getRows();

  /**
   * Shortcut to return an immutable list of {@link io.github.msdk.datamodel.Sample}s found in this feature table.
   *
