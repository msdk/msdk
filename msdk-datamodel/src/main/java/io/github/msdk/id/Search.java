...
public interface Search {
   ...
   */
  @Nonnull
  Iterator<MsSpectrum> findSpectrumByProperty(String propertyName, Serializable propertyValue)
      throws IOException;
   ...
   */
  @Nonnull
  Iterator<MsSpectrum> findSimilarSpectra(MsSpectrum compare, Integer minSimilarity)
      throws IOException;
}
