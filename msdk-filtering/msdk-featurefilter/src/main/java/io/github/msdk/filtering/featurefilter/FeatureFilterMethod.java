...
public class FeatureFilterMethod implements MSDKMethod<FeatureTable> {
    ...
    public FeatureFilterMethod(@Nonnull FeatureTable featureTable,
            ...
            @Nonnull boolean filterByDuration, @Nonnull boolean filterByArea,
            @Nonnull boolean filterByHeight,
            @Nonnull boolean filterByDataPoints, @Nonnull boolean filterByFWHM,
            @Nonnull boolean filterByTailingFactor,
            @Nonnull boolean filterByAsymmetryFactor,
