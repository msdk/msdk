...
public class SetupLogging extends TestWatcher {
    ...
    /**
     * Create new instance with specified properties from a URL, e.g. a
     * classpath resource.
     *
     * @param props
     *            the properties url
    ...
    public SetupLogging(URL props) {
        ...
        try {
            ...
            Logger.getLogger(SetupLogging.class.getName()).log(Level.SEVERE,
                    null, ex);
    ...
    /**
     * Set the log level (log4j) (
     * <code>log4j.category.clazz.getName(), level</code>) for a specific class.
     *
     * @param clazz
     *            the class to set the level for
     * @param level
     *            the log level, one of OFF, ERROR, WARN, INFO, DEBUG
     */
     ...
     *            the class or package to set the level for
     * @param level
     *            the log level, one of OFF, ERROR, WARN, INFO, DEBUG
     */
