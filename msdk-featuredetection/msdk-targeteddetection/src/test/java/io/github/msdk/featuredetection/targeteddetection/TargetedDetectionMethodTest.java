...
public class TargetedDetectionMethodTest {
    ...
    public void testOrbitrap() throws MSDKException {
        ...
        Assert.assertEquals(12.8835535, ChromatogramUtil.getRt(chromatogram1)/60, 0.000001);
        Assert.assertEquals(12.538729, ChromatogramUtil.getRtStart(chromatogram1)/60, 0.000001);
        Assert.assertEquals(13.3210535, ChromatogramUtil.getRtEnd(chromatogram1)/60, 0.000001);
        Assert.assertEquals(0.7823242, ChromatogramUtil.getDuration(chromatogram1)/60, 0.000001);
        Assert.assertEquals(5513891.5, ChromatogramUtil.getMaxHeight(chromatogram1), 0.000001);
        Assert.assertEquals(7.5199576E7, ChromatogramUtil.getArea(chromatogram1), 0.000001);
        Assert.assertEquals(20, ChromatogramUtil.getNumberOfDataPoints(chromatogram1), 0.000001);
        Assert.assertEquals(0.20610961, ChromatogramUtil.getFwhm(chromatogram1)/60, 0.000001);
        Assert.assertEquals(1.1181464, ChromatogramUtil.getTailingFactor(chromatogram1), 0.000001);
        Assert.assertEquals(1.1135141, ChromatogramUtil.getAsymmetryFactor(chromatogram1), 0.000001);
        ...
        Assert.assertEquals(14.481896, ChromatogramUtil.getRt(chromatogram2)/60, 0.000001);
        Assert.assertEquals(14.16822, ChromatogramUtil.getRtStart(chromatogram2)/60, 0.000001);
        Assert.assertEquals(14.9408865, ChromatogramUtil.getRtEnd(chromatogram2)/60, 0.000001);
        Assert.assertEquals(0.7726664, ChromatogramUtil.getDuration(chromatogram2)/60, 0.000001);
        Assert.assertEquals(6317753.0, ChromatogramUtil.getMaxHeight(chromatogram2), 0.000001);
        Assert.assertEquals(8.4486608E7, ChromatogramUtil.getArea(chromatogram2), 0.000001);
        Assert.assertEquals(18, ChromatogramUtil.getNumberOfDataPoints(chromatogram2), 0.000001);
        Assert.assertEquals(0.19513144, ChromatogramUtil.getFwhm(chromatogram2)/60, 0.000001);
        Assert.assertEquals(1.3311311, ChromatogramUtil.getTailingFactor(chromatogram2), 0.000001);
        Assert.assertEquals(1.7337204, ChromatogramUtil.getAsymmetryFactor(chromatogram2), 0.000001);
        ...
        Assert.assertEquals(10.722553, ChromatogramUtil.getRt(chromatogram3)/60, 0.000001);
        Assert.assertEquals(10.48422, ChromatogramUtil.getRtStart(chromatogram3)/60, 0.000001);
        Assert.assertEquals(11.249222, ChromatogramUtil.getRtEnd(chromatogram3)/60, 0.000001);
        Assert.assertEquals(0.7650024, ChromatogramUtil.getDuration(chromatogram3)/60, 0.000001);
        Assert.assertEquals(2609394.5, ChromatogramUtil.getMaxHeight(chromatogram3), 0.000001);
        Assert.assertEquals(3.4154492E7, ChromatogramUtil.getArea(chromatogram3), 0.000001);
        Assert.assertEquals(17, ChromatogramUtil.getNumberOfDataPoints(chromatogram3), 0.000001);
        Assert.assertEquals(0.21855775, ChromatogramUtil.getFwhm(chromatogram3)/60, 0.000001);
        Assert.assertEquals(1.4721208, ChromatogramUtil.getTailingFactor(chromatogram3), 0.000001);
        Assert.assertEquals(1.8304727, ChromatogramUtil.getAsymmetryFactor(chromatogram3), 0.000001);
