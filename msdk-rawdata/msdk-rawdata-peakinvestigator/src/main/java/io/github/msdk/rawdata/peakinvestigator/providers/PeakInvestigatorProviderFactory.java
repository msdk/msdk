...
public interface PeakInvestigatorProviderFactory {
   ...
   *
   * @return a
   *         {@link io.github.msdk.rawdata.peakinvestigator.providers.PeakInvestigatorProjectProvider}
   *         object.
   */
   ...
   * @param dataEnd a int.
   * @return a
   *         {@link io.github.msdk.rawdata.peakinvestigator.providers.PeakInvestigatorOptionsProvider}
   *         object.
   */
   ...
   * @return a
   *         {@link io.github.msdk.rawdata.peakinvestigator.providers.PeakInvestigatorInitProvider}
   *         object.
   */
