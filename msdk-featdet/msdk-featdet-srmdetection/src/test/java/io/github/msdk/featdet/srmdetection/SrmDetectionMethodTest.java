...
public class SrmDetectionMethodTest {
  ...
  public void test_mzML() throws MSDKException {
    ...
    // Group ID
    FeatureTableColumn<Integer> column = featureTable.getColumn(ColumnName.GROUPID, null);
    ...
    // m/z
    FeatureTableColumn<Double> columnMz = featureTable.getColumn(ColumnName.MZ, null);
  ...
  public void test_Thermo() throws MSDKException {
    ...
    // Q1 values
    FeatureTableColumn<Double> columnQ1 = featureTable.getColumn(ColumnName.Q1, null);
    ...
    // Q3 values
    FeatureTableColumn<Double> columnQ3 = featureTable.getColumn(ColumnName.Q3, null);
