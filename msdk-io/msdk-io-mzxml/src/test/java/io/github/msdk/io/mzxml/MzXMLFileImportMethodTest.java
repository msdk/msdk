...
public class MzXMLFileImportMethodTest {
	...
	public void testA10A2() throws MSDKException {
		...
		Float scan1MaxInt = MsSpectrumUtil.getMaxIntensity(intensityBuffer, scan1.getNumberOfDataPoints());
	...
	public void testR1RG59B41() throws MSDKException {
		...
		Float scan299MaxInt = MsSpectrumUtil.getMaxIntensity(intensityBuffer, scan299.getNumberOfDataPoints());
