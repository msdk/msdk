...
public class ThermoRawImportMethodTest {
  ...
  public void testRP240K01() throws Exception {
    ...
    Assert.assertEquals(37.692f, scan10.getChromatographyInfo().getRetentionTime(), 0.01f);
    ...
    Assert.assertEquals(202.332f, scan50.getChromatographyInfo().getRetentionTime(), 0.01f);
  ...
  public void testDrugX01() throws Exception {
    ...
    Assert.assertEquals(293.97f, scan220.getChromatographyInfo().getRetentionTime(), 0.01f);
  ...
  public void testTSQQuantum() throws Exception {
    ...
    Assert.assertEquals(14.422f, scan10.getChromatographyInfo().getRetentionTime(), 0.01f);
    Assert.assertEquals(PolarityType.POSITIVE, scan10.getPolarity());
    mzBuffer = scan10.getMzValues(mzBuffer);
    intensityBuffer = scan10.getIntensityValues(intensityBuffer);
    Float scan10maxInt =
  ...
  public void testSRM() throws Exception {
    ...
    Assert.assertEquals(9.293f, scan10.getChromatographyInfo().getRetentionTime(), 0.01f);
    Assert.assertEquals(PolarityType.POSITIVE, scan10.getPolarity());
    mzBuffer = scan10.getMzValues(mzBuffer);
    intensityBuffer = scan10.getIntensityValues(intensityBuffer);
    Float scan10maxInt =
  ...
  public void testParentScan() throws Exception {
    ...
    Assert.assertEquals(5.115f, scan10.getChromatographyInfo().getRetentionTime(), 0.01f);
  ...
  public void testCNLScan() throws Exception {
    ...
    Assert.assertEquals(5.045f, scan10.getChromatographyInfo().getRetentionTime(), 0.01f);
    Assert.assertEquals(PolarityType.POSITIVE, scan10.getPolarity());
    mzBuffer = scan10.getMzValues(mzBuffer);
    intensityBuffer = scan10.getIntensityValues(intensityBuffer);
    Float scan10maxInt =
