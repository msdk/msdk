...
public class Arrays {
  ...
  /**
   * This is a safe value used by {@link ArrayList} (as of Java 7) to avoid throwing
   * {@link OutOfMemoryError} on some JVMs. We adopt the same value.
   */
   ...
   *         <code>offset</code>+<code>length</code> is greater than <code>arrayLength</code>.
   */
