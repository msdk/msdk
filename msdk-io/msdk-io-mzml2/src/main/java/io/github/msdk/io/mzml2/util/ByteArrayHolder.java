...
public class ByteArrayHolder extends OutputStream {
   ...
   * @param keepData if true, will copy the previous contents of the buffer to the new one. If you
   *        are just reusing an old buffer for new data, you might want to set this to false, then
