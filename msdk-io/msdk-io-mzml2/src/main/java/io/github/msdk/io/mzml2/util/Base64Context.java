...
public class Base64Context {
  ...
  public String toString() {
    return String.format(
        "%s[currentLinePos=%s, eof=%s, ibitWorkArea=%s, lbitWorkArea=%s, "
            + "modulus=%s, pos=%s, readPos=%s]",
        this.getClass().getSimpleName(), currentLinePos, eof, ibitWorkArea, lbitWorkArea, modulus,
        pos, readPos);
  }
  ...
  /**
   * If your underlying buffer has navigation capabilities, you can use this method to sync
   * positions of the reader with your structure.
   */
