...
public class IsotopePatternGeneratorAlgorithmTest {
    ...
    public void testC10() throws MSDKException {
        ...
        MsSpectrum pattern = IsotopePatternGeneratorAlgorithm
                .generateIsotopes(formula, 0.0001, 1000.0f, 0.001);
    ...
    public void testC20H30Fe2P2S4Cl4() throws MSDKException {
        ...
        MsSpectrum pattern = IsotopePatternGeneratorAlgorithm
                .generateIsotopes(formula, 0.01, 1000.0f, 0.0);

        Assert.assertEquals(new Integer(35), pattern.getNumberOfDataPoints());
        Assert.assertEquals(1000.0f, pattern.getIntensityValues()[10],
                0.000001);
        Assert.assertEquals(713.8128938499999, pattern.getMzValues()[10],
                0.0000001);
    ...
    public void testF1000() throws MSDKException {
        ...
        MsSpectrum pattern = IsotopePatternGeneratorAlgorithm
                .generateIsotopes(formula, 0.001, 1000.0f, 0.001);
